...
class Checkout extends React.Component {
    ...
    validateInput(){
        ...
        if(parseInt(request[1]) < parseInt(request[2])){ 
            ...
            return <h1>Sorry! We can't fulfill this request. You're trying to check out more {request[0]}s than  we have.</h1>;
    ...
    render() {
        return (
            <div className = "App">{ this.validateInput() } </div>
        );
